...
const Login = () => {
  ...
  return (
    <div className="max-w-md mx-auto mt-12 p-8 bg-white dark:bg-gray-800 border dark:border-gray-700 rounded-xl shadow-lg transition-colors duration-300">
      ...
      <div className="mt-6 text-center">
        ...
        <p className="text-center text-gray-500 text-sm">        By continuing, you agree to AgriAI's Terms of Service and Privacy Policy.
        </p>
      </div>
    </div>
  );
